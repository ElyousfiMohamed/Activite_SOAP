 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://WebService.example.org/", wsdlLocation = "http://localhost:8080/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://WebService.example.org/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://WebService.example.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService.example.org/", "BanqueServicePort"), BanqueService.class, features);
    }

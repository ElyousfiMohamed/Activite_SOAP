...
public class ObjectFactory {
    ...
    private final static QName _GetComptes_QNAME = new QName("http://WebService.example.org/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://WebService.example.org/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://WebService.example.org/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://WebService.example.org/", name = "getComptesResponse")
